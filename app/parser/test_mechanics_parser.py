import constants
from parse_garage_language import (get_all_tokens, get_next_tokens,
                                   get_specific_tests, is_complete, parses,
                                   read_test_mappings)
...
if __name__ == '__main__':
    ...
    print(f'Rule: {process_rule(input_filename)}')

    print(f'-------------\n\nget_token_map(None)\n {get_specific_tests(None)}')
    print(
